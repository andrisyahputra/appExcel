...
Public Class FormReplace2
    ...
    Private Sub btnUReplace_Click(sender As Object, e As EventArgs) Handles btnUReplace.Click
        Dim con As OleDb.OleDbConnection = New OleDb.OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + TXTLOCATION.Text + ";Extended Properties=Excel 12.0;")
        'Dim cmd As New OleDb.OleDbCommand
        Dim da As New OleDb.OleDbDataAdapter
        Dim dt As New DataTable
        ...
        Try
            ...
            Dim cmd1 As New OleDb.OleDbDataAdapter("Select * from [" & ComboBox1.Text & "]", con)
            cmd1.TableMappings.Add("Table", "Table")
            'Dim dt As New DataSet
            cmd1.Fill(dt)
